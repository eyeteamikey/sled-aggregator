...
| unsupported_candidate | P2 | 25 | Vendor Registry | jurisdictions_unlocked=4, statewide_impact=1, public_access=2, documents=1, reuse=3, complexity=2, maintenance_risk=1, blocked_penalty=1, territory_impact=0 | Anonymous agency discovery was not reproducible in the 2026-08-01 evidence review; obtain sanitized listing and detail captures for two independently operated agencies before implementation. |
